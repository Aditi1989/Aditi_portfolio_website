    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Behind every project lies a story — of challenges, late-night debugging, and moments when code finally clicks. These aren’t just assignments; they’re experiments in blending logic, creativity, and technology to solve problems that matter.

Curious to peek under the hood? My GitHub is where these ideas live — raw, real, and always evolving. Dive in, explore the builds, and see how concepts turn into code.
        </p>
      </div>
